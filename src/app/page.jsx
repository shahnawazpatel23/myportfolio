...
//             <a href="/portfolio" className="p-4 rounded-lg ring-1 ring-black bg-black text-white hover:bg-gray-800">View my Work</a>
//             <a href="/resume_2.pdf" download="Shahnawaz's_Resume.pdf">
...
//       </div>
//       <motion.div
//         className="absolute text-[50vh] bottom-2
